  ...
  return (
    <div className="p-4 md:p-8 w-full max-w-[1600px] mx-auto animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
        <div>
           <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Rapportages</h1>
           <p className="text-slate-500 dark:text-slate-400 mt-1">Inzicht in personeelsdata.</p>
        </div>
        
        <button className="p-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors self-end sm:self-auto">
      ...
      <div className="mb-8">
        ...
        >
          <Filter size={16} className={`mr-2 ${filterActive ? 'text-teal-500 dark:text-teal-400' : 'text-slate-400'}`} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        {/* Main Chart */}
        <div className="lg:col-span-3 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 md:p-8">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-8">Personeelsverloop & Aannames</h2>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8 mt-6 text-sm">
             <div className="flex items-center gap-2">
               ...
               <span className="text-slate-600 dark:text-slate-400 font-medium">Aannames</span>
             </div>
             <div className="flex items-center gap-2">
               <div className="w-3 h-3 rounded-full bg-red-500"></div>
               <span className="text-slate-600 dark:text-slate-400 font-medium">Vertrek</span>
             </div>
             <div className="flex items-center gap-2">
               <div className="w-3 h-3 rounded-full border-2 border-slate-900 bg-white"></div>
               <span className="text-slate-600 dark:text-slate-400 font-medium">Totaal personeel</span>
             </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-8 flex flex-col justify-center">
            ...
            <div className="flex items-baseline gap-2 mb-1">
              <span className="text-4xl font-bold text-slate-900 dark:text-white">15.7%</span>
            </div>
            <div className="text-sm text-slate-500 dark:text-slate-400">Afgelopen 12 maanden</div>
          </div>

          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-8 flex flex-col justify-center">
             <div className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-2">Groei</div>
            <div className="flex items-baseline gap-2 mb-1">
              <span className="text-4xl font-bold text-slate-900 dark:text-white">0.3%</span>
            </div>
            <div className="text-sm text-slate-500 dark:text-slate-400">Netto toename</div>
          </div>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 md:p-8 h-96">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-6">Verdeling Afdelingen</h2>
