    ...
    <div className="p-6 md:p-10 w-full max-w-[2400px] mx-auto animate-in fade-in duration-500 min-h-[calc(100vh-80px)] print:p-0 print:m-0 print:h-auto print:bg-white print:overflow-visible">
      ...
      <div className="hidden print:block mb-6">
          <div className="flex justify-between items-end border-b-2 border-black pb-4 mb-6">
              <div>
                  <h1 className="text-2xl font-bold uppercase tracking-tight text-black">Linnen Audit Rapport</h1>
                  <p className="text-xs font-bold text-gray-600 uppercase">Moderna Verschillenanalyse</p>
              </div>
          ...
          <div className="grid grid-cols-3 gap-8 mb-6 text-sm text-black border-b border-gray-300 pb-4">
              <div>
                  <span className="block font-bold uppercase text-xs text-gray-500 mb-1">Geanalyseerd door</span>
                  <span className="block font-bold">{currentUser.name}</span>
                  <span className="block text-xs">{new Date().toLocaleString()}</span>
              </div>
              <div>
                  <span className="block font-bold uppercase text-xs text-gray-500 mb-1">Bestanden</span>
                  <span className="block">1 Bestelbon (Excel)</span>
                  <span className="block">{deliveryFiles.length} Leverbon(nen)</span>
              </div>
              <div>
                  <span className="block font-bold uppercase text-xs text-gray-500 mb-1">Resultaat</span>
                  <span className="block font-bold text-lg">
                      {diffTotal === 0 ? 'Correct (0)' : diffTotal > 0 ? `+${diffTotal} Overschot` : `${diffTotal} Tekort`}
                  </span>
              </div>
          </div>
      </div>
      ...
      {/* PRINT FOOTER */}
      <div className="hidden print:block mt-8 pt-8 border-t border-black page-break-inside-avoid">
